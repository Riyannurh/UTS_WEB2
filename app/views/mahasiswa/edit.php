  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Edit Mahasiswa</h6>
      </nav>
    </div>
  </nav>
          ...
          <div class="card-body">
            ...
            <form action="<?= base_url('mahasiswa/edit/' . $mahasiswa->id) ?>" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nim" name="nim" required value="<?= htmlspecialchars($mahasiswa->nim) ?>">
              </div>
